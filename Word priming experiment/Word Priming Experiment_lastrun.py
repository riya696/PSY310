...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Riya Joshi\\OneDrive\\Desktop\\Experimental Psychology\\Word Priming Experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/Riya Joshi/OneDrive/Desktop/study_word.xlsx'), 
        seed=None, 
    )
    ...
    trials_2 = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/Riya Joshi/OneDrive/Desktop/test_word.xlsx'), 
        seed=None, 
    )
    ...
    for thisTrial_2 in trials_2:
        ...
        test = data.Routine(
            name='test',
            components=[TestText, test_textbox, text, testmouse],
        )
